...
//		if(inputDto.getUrl() != null)
//        {
//            UrlShortner urlToPersist = new UrlShortner();
//            urlToPersist.setCreationDate(LocalDateTime.now());
//            urlToPersist.setOriginalUrl(inputDto.getUrl());
//            urlToPersist.setShortLink(encodeUrl(inputDto.getUrl()));
//            urlToPersist.setExpirationDate(getExpirationDate(inputDto.getExpirationDate(),urlToPersist.getCreationDate()));
//            UrlShortner urlToReturn = persistShortLink(urlToPersist);
//
//                return urlToReturn;
//        }
//		else {
...
//            urlToPersist.setShortUrlDomain(ServletUriComponentsBuilder.fromCurrentContextPath().path("/")
//					.toUriString());
            
            //Build in library
//            urlToPersist.setShortUrl(encodeUrl(inputDto.getLongUrl()));
             ///   Custom
